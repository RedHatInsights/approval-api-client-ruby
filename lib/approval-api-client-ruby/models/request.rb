...
module ApprovalApiClient
  ...
  class Request
    ...
    def hash
      [id, state, decision, reason, workflow_id, notified_at, finished_at, number_of_children, number_of_finished_children, owner, requester_name, name, description, group_name, parent_id].hash
    end
