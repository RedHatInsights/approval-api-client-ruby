...
# Unit tests for ApprovalAPIClient::StageIn
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StageIn' do
  before do
    # run before each test
    @instance = ApprovalAPIClient::StageIn.new
  end
  ...
  describe 'test an instance of StageIn' do
    it 'should create an instance of StageIn' do
      expect(@instance).to be_instance_of(ApprovalAPIClient::StageIn)
    end
  end
